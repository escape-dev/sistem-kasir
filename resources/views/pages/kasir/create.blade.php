                ...
                <form action="{{ route('kasir.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" name="name"
                            placeholder="Nama" type="text" id="nama" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('password') is-invalid @enderror" name="password_confirmation" placeholder="Confirm Password" type="password"
