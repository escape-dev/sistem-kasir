            ...
            <div class="card-body">
                <form action="{{ route('barang.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama Barang" type="text" id="nama-barang" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Harga Barang" type="number" id="harga-barang" value="{{ old('price') }}" required>
                        @error('price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
